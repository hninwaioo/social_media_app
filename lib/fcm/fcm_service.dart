...
const localNotificationChannelDescription = "This channel is used for important notification.";
...
class FCMService {
  ...
  void listenForMessages() async {
    ...
    FirebaseMessaging.onMessage.listen((remoteMessage) {
      ...
      debugPrint("Notification Sent From Sever while in foreground");
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((remoteMessage) {
      ...
      debugPrint("User pressed the notification ${remoteMessage.data['post_id']}");
    });
  ...
  /// Request IOS Foreground Notification
